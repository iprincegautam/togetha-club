...
export async function buildPartnerMePayload(
  ...
  const payload: Record<string, unknown> = {
    influencer: {
      ...
      kycDocumentType: influencer.kyc_document_type ?? null,
      kycDocumentNumber: influencer.kyc_document_number ?? null,
      kycDocUrl: influencer.kyc_doc_url ?? influencer.pan_doc_url ?? null,
