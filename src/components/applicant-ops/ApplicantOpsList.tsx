...
export interface ApplicantOpsRow {
  id: string
  name: string | null
  email: string
  phone: string | null
  ...
  return (
    <div className="admin-dashboard">
      ...
      <div className="admin-filter admin-filter-row">
        <div>
          <label className="apply-label" htmlFor="name-filter">Name</label>
          <input
            id="name-filter"
        ...
        <div>
          <label className="apply-label" htmlFor="email-filter">Email</label>
          <input
            id="email-filter"
            className="apply-input admin-filter-select"
            type="search"
        ...
        <div>
          <label className="apply-label" htmlFor="date-filter">Travel date</label>
          <select
            id="date-filter"
        ...
        <div>
          <label className="apply-label" htmlFor="gender-filter">Gender</label>
          <select
            id="gender-filter"
            className="apply-select admin-filter-select"
        ...
        <div>
          <label className="apply-label" htmlFor="status-filter">Filter by status</label>
          <select
            id="status-filter"
            className="apply-select admin-filter-select"
        ...
        <div>
          <label className="apply-label" htmlFor="lead-filter">Lead type</label>
          <select
            id="lead-filter"
            className="apply-select admin-filter-select"
            value={filters.lead}
              ...
              filtered.map((row) => {
                ...
                return (
                  <tr key={row.id}>
                    ...
                    <td>
                      <Link href={href} className="admin-inline-link">View →</Link>
                      {canShowCredentialsAction(row.status) && (
                        <>
                          {' · '}
                          <Link href={`${href}#member-portal`} className="admin-inline-link">
                            Credentials
                          </Link>
                        </>
                      )}
                      {(row.status === 'deposit_paid' || row.status === 'paid') && (
                        <>
                          {' · '}
                          <Link href={`${href}#balance-email`} className="admin-inline-link">
                            Payments
                          </Link>
                        </>
                      )}
