...
/* ── Static tab content (ported from togetha-batches.html) ── */
...
type BatchRow = Pick<Batch, 'slug' | 'name' | 'price' | 'status'>
    ...
    <>
      <div className="page-hero">
        ...
        <p className="page-hero-sub">
          Two departures a month. 24 screened singles each. The Himalayas do the rest. This isn&apos;t
          booking a trip — this is buying into the best decision you&apos;ll make this year.
        </p>
        <div className="doodle-divider">~ ~ ♡ ~ ~</div>
      </div>

      <div className="batch-section-header" id="batch-a">
        <div className="batch-label-pill">✦ Batch A — GenZ Edition</div>
      ...
      <div className="batch-section-header" id="batch-b">
        <div className="batch-label-pill rose-pill">✦ Batch B — Millennial Edition</div>
        <h2 className="batch-section-title">
      ...
      <div className="batches-cta" id="apply">
        <div className="batches-cta-inner">
          <div className="batches-cta-eyebrow">✦ Ready? ✦</div>
          <h2 className="batches-cta-title">
            The mountains are waiting.
            <br />
            <span className="gold">So is your person.</span>
          </h2>
          <p className="batches-cta-sub">
            Applications take 5 minutes. We reply within 48 hours. Your spot waits 15 minutes while
            you pay. After that — it&apos;s yours.
          </p>
          <div className="batches-cta-btns">
            <Link href={`${ROUTES.batches}#batch-a`} className="batches-cta-btn teal">
              ✦ Apply for Batch A (GenZ)
            </Link>
            <Link href={`${ROUTES.batches}#batch-b`} className="batches-cta-btn rose">
              ♡ Apply for Batch B (Millennial)
            </Link>
          </div>
