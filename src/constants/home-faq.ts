export const HOME_FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'Still a 6-day trip in the Himalayas with 23 interesting, vetted singles who chose to show up. Pilot batches reported deep friendships, clarity on what they want, and stories they\'re still telling. Romance is possible — it\'s not guaranteed, and that\'s intentional.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Some of our strongest connections have been between people who don\'t love small talk. Activities are structured so nobody has to perform. There\'s free time, no forced participation, and the mountains do a lot of the work for you.',
  },
  {
    question: "What's included in the trip price?",
    answer:
      'Transport from Delhi, curated stays, most meals, ice-breaker activities, bonfire night, and the full batch experience. Exact inclusions vary slightly by batch — see each batch page for the line-item breakdown before you pay.',
  },
  {
    question: 'What about refunds and cancellations?',
    answer:
      'Refund rules depend on how close you are to departure and whether we can fill your spot. Full policy is on our Cancellation & Refund page — read it before you pay so there are no surprises.',
  },
] as const
